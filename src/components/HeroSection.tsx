  ...
  return (
    ...
    >
        ...
        <div className="p-4 relative - z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cum necessitatibus eaque doloremque totam rem cumque inventore iure molestias eligendi ad, aperiam quae odio aliquam modi molestiae? Assumenda molestiae eum suscipit, minus at, aliquid odio esse odit modi, dignissimos a libero.</p>
            <div className="mt-4">
                <Link href={"/courses"}>
                    <Button 
